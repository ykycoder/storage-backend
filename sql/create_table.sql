...
-- ----------------------------
-- Table structure for storage_share_file
-- ----------------------------
DROP TABLE IF EXISTS `storage_share_file`;
CREATE TABLE `storage_share_file`
(
...
-- ----------------------------
-- Table structure for storage_user_file
-- ----------------------------
DROP TABLE IF EXISTS `storage_user_file`;
...
-- ----------------------------
-- Table structure for storage_user_search_history
-- ----------------------------
DROP TABLE IF EXISTS `storage_user_search_history`;
CREATE TABLE `storage_user_search_history`
(
    `id`             bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `user_id`        bigint(0) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for storage_file_chunk
-- ----------------------------

DROP TABLE IF EXISTS `storage_file_chunk`;
CREATE TABLE `storage_file_chunk`
(
...
-- ----------------------------
-- Table structure for storage_error_log
-- ----------------------------

DROP TABLE IF EXISTS `storage_error_log`;
CREATE TABLE `storage_error_log`
(
    `id`          bigint                           NOT NULL AUTO_INCREMENT COMMENT '主键',
